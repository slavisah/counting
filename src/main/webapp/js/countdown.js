...
function(module) {
	 ...
	 * @return {string}
	 */
	Timespan.prototype.toCustomString = function(emptyLabel) {
		var label = [];
		label.push(plurality(this.hours, LABEL_HOURS));
		label.push(plurality(this.minutes, LABEL_MINUTES));
		label.push(plurality(this.seconds, LABEL_SECONDS));
